...
The results on **DOTA_subsize1024_gap200_rate1.0** test-dev set are shown in the table below. (**password: yolo**)
 ...
 | ----                                                                                                                                                           | ---  | ---   | ---      | ---   | ---   | ---   | ---   | --- | --- | ---
 |yolov5x [[google](https://drive.google.com/file/d/1l23xxN3FIbonND0EckhULx-XNaU9bpof/view?usp=sharing)]  |1024  | ×     |- |- |-  |-      |-     |-      |-   |-   
 |yolov5l [[google](https://drive.google.com/file/d/1MYSPLYIkvhByc-nhgB8NKu-v5FtIqgss/view?usp=sharing)]  |1024  | ×     |- |- |-  |-      |-     |-      |-   |-   
